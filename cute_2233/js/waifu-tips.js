...
$(".waifu").css({'top':$(window).height()-270,'left':0});
...
//血小板的伴娘
//loadlive2d("live2d", "http://121.199.71.176/wp-content/themes/lineday/live2d/model/cute/model.json");
loadlive2d('live2d',$(".l2d_xb").attr("data-api")+'/model/cute/model.json');
...
$(window).resize(function(){
    $(".waifu").css('top',window.innerHeight-270)
});
...
(function(){
    ...
    //目标位置，默认左下角
    $(".waifu").animate({top:$(window).height()-270,left:0},800);
